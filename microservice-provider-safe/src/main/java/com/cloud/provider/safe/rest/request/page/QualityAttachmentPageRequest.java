...
public class QualityAttachmentPageRequest extends BaseRestRequest {
	 ...
	 * @author wei.yong
	 */
	private static class QualityAttachmentConvert extends Converter<QualityAttachmentPageRequest, QualityAttachment> {

		@Override
		protected QualityAttachment doForward(QualityAttachmentPageRequest qualityAttachmentRequest) {
		...
		@Override
		protected QualityAttachmentPageRequest doBackward(QualityAttachment b) {
			return null;
		}
