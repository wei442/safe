...
public class OrgPageRequest extends BaseRestRequest {
	 ...
	 * @author wei.yong
	 */
	private static class OrgConvert extends Converter<OrgPageRequest, Org> {

		@Override
		protected Org doForward(OrgPageRequest orgRequest) {
			Org org = new Org();
		...
		@Override
		protected OrgPageRequest doBackward(Org b) {
			return null;
		}
