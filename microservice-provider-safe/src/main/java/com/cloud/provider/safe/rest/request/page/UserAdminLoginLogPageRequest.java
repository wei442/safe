...
public class UserAdminLoginLogPageRequest extends BaseRestRequest {
	 ...
	 * @author wei.yong
	 */
	private static class UserAdminLoginLogConvert extends Converter<UserAdminLoginLogPageRequest, UserAdminLoginLog> {

		@Override
		protected UserAdminLoginLog doForward(UserAdminLoginLogPageRequest userAdminLoginLogRequest) {
		...
		@Override
		protected UserAdminLoginLogPageRequest doBackward(UserAdminLoginLog b) {
			return null;
		}
