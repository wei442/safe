...
public class QualityAttachmentServiceImpl extends BaseService implements IQualityAttachmentService {
	 ...
	 */
	@Override
	public JSONObject getQualityAttachmentListByPage(Map<String, Object> params) {
	 ...
	 */
	@Override
	public JSONObject getQualityAttachmentList(Map<String, Object> params) {
	 ...
	 */
	@Override
	public JSONObject addQualityAttachment(Map<String, Object> params) {
	 ...
	 */
	@Override
	public JSONObject updateQualityAttachment(Map<String, Object> params) {
