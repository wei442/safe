...
import com.cloud.consumer.safe.vo.account.AccountCalculateCivilizeTaskVo;
import com.cloud.consumer.safe.vo.account.AccountCalculateTaskVo;
import com.cloud.consumer.safe.vo.calculate.CalculateRankContentVo;
import com.cloud.consumer.safe.vo.calculate.LoginCalculateRealRankVo;
import com.cloud.consumer.safe.vo.coupon.CouponVo;
import com.cloud.consumer.safe.vo.diamond.DiamondConfigVo;
import com.cloud.consumer.safe.vo.diamond.DiamondRankContentVo;
import com.cloud.consumer.safe.vo.diamond.LoginDiamondRealRankVo;
import com.cloud.consumer.safe.vo.gofun.AreaVo;
import com.cloud.consumer.safe.vo.gofun.CarOrderVo;
import com.cloud.consumer.safe.vo.gofun.UserTaskVo;
import com.cloud.consumer.safe.vo.user.UserCalculateConfigVo;
import com.cloud.consumer.safe.vo.user.UserCarOrderVo;
