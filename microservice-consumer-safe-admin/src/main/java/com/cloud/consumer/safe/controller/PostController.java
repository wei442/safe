...
public class PostController extends BaseController {
	...
	public BaseRestMapResponse getPostListByPage(
		...
		JSONObject jsonPost = postService.getPostListByPage(params);
	...
	public BaseRestMapResponse getPost(
		...
		String retCode = Objects.toString(jsonPost.get(RetSafeConstants.RET_CODE), "");
	...
	public BaseRestMapResponse addPost(
		...
		JSONObject jsonPost = postService.addPost(params);
