...
public class UserInfoServiceImpl extends BaseService implements IUserInfoService {
	...
	public JSONObject getUserInfoListByPage(Object params) {
		...
		JSONObject response = this.safePostForObject(SafeUrlConstants.user_title+"/selectUserInfoListByPage", params, JSONObject.class);
		return response;
	}
	...
	public JSONObject getUserInfoList(Object params) {
		...
		JSONObject response = this.safePostForObject(SafeUrlConstants.user_title+"/selectUserInfoList", params, JSONObject.class);
		return response;
	}
	...
	public JSONObject getUserInfoById(Integer id) {
		...
		JSONObject response = this.safePostForObject(SafeUrlConstants.user_title+"/selectUserInfoById/"+id, null, JSONObject.class);
		return response;
	}
	...
	public JSONObject addUserInfo(Object params) {
		...
		JSONObject response = this.safePostForObject(SafeUrlConstants.user_title+"/insertUserInfo", params, JSONObject.class);
		return response;
	}
	...
	public JSONObject deleteUserInfoById(Integer id) {
		...
		JSONObject response = this.safePostForObject(SafeUrlConstants.user_title+"/deleteUserInfoById/"+id, null, JSONObject.class);
		return response;
	}
	...
	public JSONObject updateUserInfo(Object params) {
		...
		JSONObject response = this.safePostForObject(SafeUrlConstants.user_title+"/modifyUserInfo", params, JSONObject.class);
		return response;
	}
