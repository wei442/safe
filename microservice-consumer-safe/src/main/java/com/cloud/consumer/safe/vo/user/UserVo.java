...
public class UserVo implements Serializable {
    ...
    private Integer diamondSort;

    private Integer calculateSort;
	...
	public Integer getDiamondSort() {
		return this.diamondSort;
	}

	public void setDiamondSort(Integer diamondSort) {
		this.diamondSort = diamondSort;
	}

	public Integer getCalculateSort() {
		return this.calculateSort;
	}

	public void setCalculateSort(Integer calculateSort) {
		this.calculateSort = calculateSort;
	}
	...
	public String toString() {
		return "UserVo [userId=" + userId + ", gId=" + gId + ", userAccount=" + userAccount + ", userName=" + userName
				...
				+ ", cityCode=" + cityCode + ", cityName=" + cityName + ", loginCount=" + loginCount + ", accountId="
				+ accountId + ", diamond=" + diamond + ", accountCalculateId=" + accountCalculateId + ", calculate="
				+ calculate + ", civilizeCalculate=" + civilizeCalculate + ", taskCalculate=" + taskCalculate
				+ ", diamondSort=" + diamondSort + ", calculateSort=" + calculateSort + "]";
	}
