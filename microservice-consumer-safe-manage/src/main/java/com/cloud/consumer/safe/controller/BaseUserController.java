...
public class BaseUserController extends BaseController {
	...
	public BaseRestMapResponse login(
		...
		logger.info("===step2:【用户登录】(UserController-login)-用户登录第一步, jsonBaseUser:{}", jsonBaseUser);
		UserInfoVo userInfoVo = JSONObject.toJavaObject(jsonBaseUser, UserInfoVo.class);
		UserAdminVo userAdminVo = JSONObject.toJavaObject(jsonBaseUser, UserAdminVo.class);
		UserAdminLoginVo userAdminLoginVo = JSONObject.toJavaObject(jsonBaseUser, UserAdminLoginVo.class);
