...
public class PostServiceImpl extends BaseService implements IPostService {
	...
	public JSONObject getListByPage(Object params) {
		logger.info("(PostService-getListByPage)-分页获取岗位列表-传入参数, params:{}", params);
	...
	public JSONObject getList(Object params) {
		logger.info("(PostService-getList)-获取岗位列表-传入参数, params:{}", params);
	...
	public JSONObject getById(Integer id) {
		logger.info("(PostService-getById)-根据id获取岗位-传入参数, id:{}", id);
	...
	public JSONObject add(Object params) {
		logger.info("(PostService-add)-新增岗位-传入参数, params:{}", params);
	...
	public JSONObject deleteById(Integer id) {
		logger.info("(PostService-deleteById)-根据id获取岗位-传入参数, id:{}", id);
	...
	public JSONObject update(Object params) {
		logger.info("(PostService-update)-修改岗位-传入参数, params:{}", params);
