...
public class SafeUrlConstants {
	...
	//字典子项
	public static final String dict_item = HttpUrlConstants.HTTP_MICROSERVICE_PROVIDER_SAFE + "/dict/item";
	//企业
	public static final String enterprise = HttpUrlConstants.HTTP_MICROSERVICE_PROVIDER_SAFE + "/enterprise";
	//企业资质
	public static final String enterprise_quality = HttpUrlConstants.HTTP_MICROSERVICE_PROVIDER_SAFE + "/enterprise/quality";
	...
	//资质附件
	public static final String quality_attachment = HttpUrlConstants.HTTP_MICROSERVICE_PROVIDER_SAFE + "/quality/attachment";
	//资质
	public static final String quality = HttpUrlConstants.HTTP_MICROSERVICE_PROVIDER_SAFE + "/quality";
	//职务
