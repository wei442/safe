package com.cloud.common.constants.ipfs;

import com.cloud.common.constants.RetConstants;

/**
 * ret ipfs 返回错误码-返回给app
 * @author wei.yong
 * @2017年04月24日
 */
public class RetIpfsConstants extends RetConstants {
	...
	public static final String DATA_ERROR_MSG = "传入数据错误";

	/**
	 * 错误编码-ipfs错误
	 */
	public static final String IPFS_ERROR = "0100005";
