...
public class UserVo implements Serializable {
	...
	public String toString() {
		return "UserVo [userId=" + userId + ", gId=" + gId + ", userAccount=" + userAccount + ", userName="
				...
				+ ", loginCount=" + loginCount + ", createTime=" + createTime + ", updateTime=" + updateTime
				+ ", accountId=" + accountId + ", diamond=" + diamond + ", accountCalculateId=" + accountCalculateId
				+ ", calculate=" + calculate + ", civilizeCalculate=" + civilizeCalculate + ", taskCalculate="
				+ taskCalculate + "]";
	}
